...
#This will suppress all messages that have a lower level of seriousness than error messages, while running or loading Scapy i.e. after sudo scapy
...
try:
    from scapy.all import *  # thi sis recommnended  instead of "from scapy import*  or import scapy"
...
'''
try: # in linux setting the promisc mode is done by ifconfig[interface]promisc, the rest is suprress the other errors a..
