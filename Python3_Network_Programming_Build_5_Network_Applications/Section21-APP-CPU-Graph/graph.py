import matplotlib.pyplot as pyp  ## 2 used functions of matplotlib  'as' alias
...
# no of rows, no of column,  and index 1.
...
def animation_function(i):
    ...
    cpu_data = open("/home/devnetadmin/DevNet/Training/Python3_Network_Programming_Build_5_Network_Applications/Section21-APP-CPU-Graph/cpu.txt").readlines()
